...
RCS_ID("$Header: svn+ssh://source.omnigroup.com/Source/svn/Omni/tags/OmniSourceRelease_2007-10-25/OmniGroup/Frameworks/OmniFoundation/FileManagement.subproj/OFCacheFile.m 93428 2007-10-25 16:36:11Z kc $");
    ...
    if (contentData != nil) {
        ...
        if (unlink([filename fileSystemRepresentation]) == 0) {
            ...
            if (errno == ENOENT || errno == ENOTDIR)
                ...
                OFErrorWithInfo(outError, OFCacheFileUnableToWriteError, NSLocalizedDescriptionKey, [NSString stringWithFormat:NSLocalizedStringFromTableInBundle(@"Unable to write cache file to '%@'", nil, OMNI_BUNDLE, @"error description"), filename], NSUnderlyingErrorKey, posixError, nil);
            }
        }
    }
