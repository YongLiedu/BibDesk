...
RCS_ID("$Header: svn+ssh://source.omnigroup.com/Source/svn/Omni/tags/OmniSourceRelease_2007-10-25/OmniGroup/Frameworks/OmniFoundation/Tests/OFCompressionTest.m 93428 2007-10-25 16:36:11Z kc $");
...
- (void)doTestWithData:(NSData *)data;
{
    ...
    for(levelIndex = 0; levelIndex < 4; levelIndex ++) {
        ...
        fd = open([filename2 UTF8String], O_WRONLY|O_CREAT, 0666);
