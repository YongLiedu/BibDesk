...
RCS_ID("$Header: svn+ssh://source.omnigroup.com/Source/svn/Omni/tags/OmniSourceRelease_2007-10-25/OmniGroup/Frameworks/OmniFoundation/XML/OFXMLDocument.m 90130 2007-08-15 07:15:53Z bungi $");
           ...
           stringEncoding:(CFStringEncoding)stringEncoding;
{
    ...
    self = [self initWithRootElement:element dtdSystemID:NULL dtdPublicID:nil whitespaceBehavior:whitespaceBehavior stringEncoding:stringEncoding];
    [element release];
    return self;
}
    ...
    if (!asFragment) {
        // Add processing instructions.  This includes the 'xml' PI at the beginning of the file.
        {
            ...
            for (piIndex = 0; piIndex < piCount; piIndex++) {
                ...
                OFXMLBufferAppendString(xml, (CFStringRef)[processingInstruction objectAtIndex:0]);
                OFXMLBufferAppendASCIICString(xml, " ");
