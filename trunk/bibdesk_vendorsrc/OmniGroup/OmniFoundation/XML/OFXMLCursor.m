...
RCS_ID("$Header: svn+ssh://source.omnigroup.com/Source/svn/Omni/tags/OmniSourceRelease_2007-10-25/OmniGroup/Frameworks/OmniFoundation/XML/OFXMLCursor.m 90130 2007-08-15 07:15:53Z bungi $");
...
NSString *OFXMLLoadError = @"OFXMLLoadError";

void OFXMLRejectElement(OFXMLCursor *cursor)
{
    NSString *format = NSLocalizedStringFromTableInBundle(@"Element '%@' not allowed at path: %@", @"OmniFoundation", [OFXMLCursor bundle], "exception reason");
