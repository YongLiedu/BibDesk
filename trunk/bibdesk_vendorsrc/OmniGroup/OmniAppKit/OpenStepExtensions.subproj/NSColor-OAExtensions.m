...
RCS_ID("$Header: svn+ssh://source.omnigroup.com/Source/svn/Omni/tags/OmniSourceRelease_2007-10-25/OmniGroup/Frameworks/OmniAppKit/OpenStepExtensions.subproj/NSColor-OAExtensions.m 93131 2007-10-20 21:33:42Z kevin $")
...
+ (NSColor *)colorWithSimilarName:(NSString *)aName;
{
	...
	// Avoid crasher below if something goes wrong in building the entries
	OBASSERT_NOT_REACHED("No color entries found");
    // CMH: fixed a bug. This was returning @"", which is not an NSColor
	return nil;
    }
