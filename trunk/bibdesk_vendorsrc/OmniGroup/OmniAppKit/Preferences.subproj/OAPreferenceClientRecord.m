...
RCS_ID("$Header: svn+ssh://source.omnigroup.com/Source/svn/Omni/tags/OmniSourceRelease_2007-10-25/OmniGroup/Frameworks/OmniAppKit/Preferences.subproj/OAPreferenceClientRecord.m 68913 2005-10-03 19:36:19Z kc $")
...
- (OAPreferenceClient *)createClientInstanceInController:(OAPreferenceController *)controller;
{
    ...
    if (!defaultsArray)
        ...
        [defaultsArray autorelease];
        defaultsArray = [[defaultsArray arrayByAddingObjectsFromArray:[defaultsDictionary allKeys]] retain];
    }
