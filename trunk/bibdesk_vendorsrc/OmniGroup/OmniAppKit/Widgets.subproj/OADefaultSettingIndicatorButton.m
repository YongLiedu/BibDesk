...
RCS_ID("$Header: svn+ssh://source.omnigroup.com/Source/svn/Omni/tags/OmniSourceRelease_2007-10-25/OmniGroup/Frameworks/OmniAppKit/Widgets.subproj/OADefaultSettingIndicatorButton.m 68913 2005-10-03 19:36:19Z kc $")
...
- (void)repositionWithRespectToSnuggleView;
{
    ...
    if ([snuggleUpToRightSideOfView isKindOfClass:[NSControl class]]) {
        ...
        if ([cell alignment] == NSLeftTextAlignment &&
            ![snuggleUpToRightSideOfControl isKindOfClass:[NSSlider class]] &&
