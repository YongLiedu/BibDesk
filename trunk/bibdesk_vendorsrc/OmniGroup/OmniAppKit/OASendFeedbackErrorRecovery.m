...
RCS_ID("$Header: svn+ssh://source.omnigroup.com/Source/svn/Omni/tags/OmniSourceRelease_2007-10-25/OmniGroup/Frameworks/OmniAppKit/OASendFeedbackErrorRecovery.m 93428 2007-10-25 16:36:11Z kc $")
...
{
    return NSLocalizedStringFromTableInBundle(@"Report Error via Email", nil, OMNI_BUNDLE, @"error recovery description for button title");
}
