...
RCS_ID("$Header: svn+ssh://source.omnigroup.com/Source/svn/Omni/tags/OmniSourceRelease_2007-10-25/OmniGroup/Frameworks/OmniAppKit/Widgets.subproj/OASlowLoadingImage.m 93428 2007-10-25 16:36:11Z kc $");
...
- (void)_update:(BOOL)final error:(NSError *)err
{
    ...
    if (final && imageParser) {
        ...
        imageParser = CGImageSourceCreateWithData((CFDataRef)dataBuffer, opts);
#endif
    }
    
    NSLog(@"Count = %d", CGImageSourceGetCount(imageParser));
    CFShow(CGImageSourceCopyProperties(imageParser, NULL));
