...
RCS_ID("$Header: svn+ssh://source.omnigroup.com/Source/svn/Omni/tags/OmniSourceRelease_2007-10-25/OmniGroup/Frameworks/OmniAppKit/Preferences.subproj/OAPreferenceClient.m 89466 2007-08-01 23:35:13Z kc $")
...
{
    if (![self initWithTitle:[clientRecord title] defaultsArray:[clientRecord defaultsArray] controller:controller])
        return nil;
...
#ifdef DEBUG_kc
            NSLog(@"Non-default value: '%@' = '%@'", [aPreference key], [aPreference objectValue]);
#endif
            return YES;
        }
    }
