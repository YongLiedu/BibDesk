...
RCS_ID("$Header: svn+ssh://source.omnigroup.com/Source/svn/Omni/tags/OmniSourceRelease_2007-10-25/OmniGroup/Frameworks/OmniAppKit/Carbon/OAOSAScript.m 93428 2007-10-25 16:36:11Z kc $")
...
- (void)setSourceCode:(NSString *)someSource;
{
    ...
    const char *cStr = [someSource UTF8String];
    AECreateDesc(typeChar, cStr, strlen(cStr), &descriptor);
