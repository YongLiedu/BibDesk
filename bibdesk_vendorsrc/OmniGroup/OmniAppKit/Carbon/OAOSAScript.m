...
RCS_ID("$Header: svn+ssh://source.omnigroup.com/Source/svn/Omni/tags/OmniSourceRelease_2006-09-07/OmniGroup/Frameworks/OmniAppKit/Carbon/OAOSAScript.m 68913 2005-10-03 19:36:19Z kc $")
...
- initWithPath:(NSString *)scriptPath;
{
    ...
    NS_DURING {
        fork = [[OFResourceFork alloc] initWithContentsOfFile:scriptPath];
        data = [fork dataForResourceType:kOSAScriptResourceType atIndex:0];
        [fork release];
    } NS_HANDLER {
