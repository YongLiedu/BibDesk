...
RCS_ID("$Header: svn+ssh://source.omnigroup.com/Source/svn/Omni/tags/OmniSourceRelease_2007-10-25/OmniGroup/Frameworks/OmniFoundation/Tests/OFRelativeDateParserTests.m 92218 2007-10-02 23:36:48Z wiml $")
...
//    } else
	...
	if (![testResult isEqual:testDate])
	    NSLog (@"--failure testdate: %@,  dot date: %@, expected: %@", testDate, testResult, testDate);
    }
