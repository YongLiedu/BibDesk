...
/* Internal functions called by code in NSString-OFExtensions.m. Update that file if you change these. */
...
static inline struct OFCharacterScanResult OFScanUTF8CharactersIntoBuffer(struct OFStringDecoderState state, const unsigned char *in_bytes, unsigned int in_bytes_count, unichar *out_characters, unsigned int out_characters_max)
{
