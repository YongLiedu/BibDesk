...
// Raw calls
extern void DTSwap2Bytes(unsigned char *data,int numberOfBytes);
extern void DTSwap4Bytes(unsigned char *data,int numberOfBytes);
extern void DTSwap8Bytes(unsigned char *data,int numberOfBytes);
