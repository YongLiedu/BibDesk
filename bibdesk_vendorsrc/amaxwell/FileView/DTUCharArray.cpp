...
DTUCharArrayStorage::DTUCharArrayStorage(long int mv,long int nv,long int ov)
{
...
DTMutableUCharArray DTUCharArray::Copy() const
{
    ...
    memcpy(CopyInto.Pointer(),Pointer(),Length()*sizeof(unsigned char));
    return CopyInto;
}
...
DTMutableUCharArray TruncateSize(const DTUCharArray &A,long int length)
{
    ...
    memcpy(toReturn.Pointer(),A.Pointer(),length*sizeof(unsigned char));
    return toReturn;
}

DTMutableUCharArray IncreaseSize(const DTUCharArray &A,long int addLength)
{
    if (addLength<0) {
    ...
    DTMutableUCharArray toReturn(newM,newN,newO);
    memcpy(toReturn.Pointer(),A.Pointer(),A.Length()*sizeof(unsigned char));
    return toReturn;
}

void DTUCharArray::PrintErrorMessage(long int i) const
{
    DTErrorOutOfRange("DTUCharArray",i,Storage->length);
}

void DTUCharArray::PrintErrorMessage(long int i,long int j) const
{
    DTErrorOutOfRange("DTUCharArray",i,j,Storage->m,Storage->n);
}

void DTUCharArray::PrintErrorMessage(long int i,long int j,long int k) const
{
